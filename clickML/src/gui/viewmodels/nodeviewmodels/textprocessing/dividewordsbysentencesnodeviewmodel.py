...
class DivideWordsBySentencesNodeViewModel(MLComponentNodeViewModel):
    ...
    @property
    def title(self):
        return "Divide Words By Sentence"
    @property
    ...
    def ml_component_descriptor(self) -> MLComponentDescriptor:
        descriptor = DivideWordsBySentencesDescriptor(self.component_id)
