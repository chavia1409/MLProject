...
class PlotNodeBody(StackLayoutedNodeBodyBase, ContextView):
    ...
    def _on_context_changed(self):
        self.ids.plot_input.context = self.context.plot_input
        self.ids.raw_input.context = self.context.raw_input
