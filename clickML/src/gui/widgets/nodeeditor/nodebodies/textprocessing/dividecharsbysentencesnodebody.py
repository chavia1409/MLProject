...
class DivideCharsBySentencesNodeBody(StackLayoutedNodeBodyBase):
    ...
    def _on_context_changed(self):
        self.ids.input_text_input.context = self.context.input_text
        self.ids.prediction_input_output.context = self.context.prediction_input
