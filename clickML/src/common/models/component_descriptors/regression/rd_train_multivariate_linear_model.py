...
from backend.ml_components.regression.r_train_fit_multivariate_lin import Train_Fit_Multivariate_Linear
from common.models.pre_suc_descriptors import PredecessorDescriptor, SuccessorDescriptor


class TrainMultivariateLinearRegressionDescriptor(MLComponentDescriptor):
    """
    Descriptor for multivariate linear regression
    ...
    def component_type(self) -> str:
        return Train_Fit_Multivariate_Linear.__name__

    def restore_component(self) -> Train_Fit_Multivariate_Linear:
        return Train_Fit_Multivariate_Linear(self)
