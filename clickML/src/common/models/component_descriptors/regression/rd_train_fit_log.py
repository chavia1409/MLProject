...
from backend.ml_components.regression.r_train_fit_log import Train_Fit_Log
from common.models.mlcomponentdescriptor import MLComponentDescriptor
from common.models.pre_suc_descriptors import PredecessorDescriptor, SuccessorDescriptor
from common.models.component_descriptors.component_constants import DEFAULT


class Train_Fit_Log_Descriptor(MLComponentDescriptor):
    """
    Descriptor for standardized, precasted logistic regression
    ...
    def component_type(self) -> str:
        return Train_Fit_Log.__name__

    def restore_component(self) -> Train_Fit_Log:
        return Train_Fit_Log(self)
