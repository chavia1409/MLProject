...
from backend.ml_components.text_processing.c_divide_chars_by_length import DivideCharsByLength
from common.models.component_descriptors.component_constants import DEFAULT
from common.models.mlcomponentdescriptor import MLComponentDescriptor
from common.models.pre_suc_descriptors import PredecessorDescriptor, SuccessorDescriptor


class DivideCharsByLengthDescriptor(MLComponentDescriptor):
    """
    Descriptor for DivideCharsByLength component.
    ...
    def component_type(self) -> str:
        return DivideCharsByLength.__name__

    def restore_component(self) -> DivideCharsByLength:
        return DivideCharsByLength(self)
