...
from backend.ml_components.text_processing.c_divide_words_by_length import DivideWordsByLength
from common.models.component_descriptors.component_constants import DEFAULT
from common.models.mlcomponentdescriptor import MLComponentDescriptor
from common.models.pre_suc_descriptors import PredecessorDescriptor, SuccessorDescriptor


class DivideWordsByLengthDescriptor(MLComponentDescriptor):
    """
    Descriptor for DivideWordsByLength component.
    ...
    Attributes:
        ...
        seq_length: Union[int, str]
            (required) number of characters in each sequence, should be int
    """
    ...
    def __init__(self, component_id: uuid) -> None:
        ...
        self.seq_length: Union[int, str] = DEFAULT
    ...
    def component_type(self) -> str:
        return DivideWordsByLength.__name__

    def restore_component(self) -> DivideWordsByLength:
        return DivideWordsByLength(self)
