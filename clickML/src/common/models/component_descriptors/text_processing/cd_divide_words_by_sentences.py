...
from backend.ml_components.text_processing.c_divide_words_by_sentences import DivideWordsBySentences
from common.models.component_descriptors.component_constants import DEFAULT
from common.models.mlcomponentdescriptor import MLComponentDescriptor
from common.models.pre_suc_descriptors import PredecessorDescriptor, SuccessorDescriptor


class DivideWordsBySentencesDescriptor(MLComponentDescriptor):
    """
    Descriptor for DivideWordsBySentences component.
    ...
    def component_type(self) -> str:
        return DivideWordsBySentences.__name__

    def restore_component(self) -> DivideWordsBySentences:
        return DivideWordsBySentences(self)
