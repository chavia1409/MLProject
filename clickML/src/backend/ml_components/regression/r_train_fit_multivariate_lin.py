...
class Train_Fit_Multivariate_Linear(MLComponent):
    def __init__(self, descriptor: TrainMultipleLinearRegressionDescriptor) -> None:
        ...
        self.dependentValues = desc.dependentValues
    ...
    def to_code(self) -> str:
        code = ""
        code += "X = csvName["+self.dependentValues+"] \n"
    ...
    def type(self) -> Components:
        return Components.TRAIN_FIT_MULTIVARIATE_LINEAR
